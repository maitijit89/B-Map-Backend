...
class OfflineService:
    ...
    async def get_offline_cities(self) -> list:
        """
        Get list of cities available for offline map download.
        """
        return [
            {
                "city_id": "beijing",
                "name": "Beijing",
                "country": "China",
                "package_size_bytes": 1024 * 1024 * 342,  # 342 MB
            ...
            },
            {
                ...
                "name": "Shanghai",
                "country": "China",
                "package_size_bytes": 1024 * 1024 * 412,  # 412 MB
            ...
            },
            {
                ...
                "name": "Bengaluru",
                "country": "India",
                "package_size_bytes": 1024 * 1024 * 156,  # 156 MB
    ...
    async def get_offline_package(self, city_id: str) -> dict:
        """
        Retrieve offline package details including download URL.
        """
