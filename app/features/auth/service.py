...
from app.features.auth.schemas import UserCreate, UserLogin, AuthResponse, UserResponse, UserMeResponse, GamificationProgress
...
class AuthService:
    ...
    def create_temp_verification_token(self, identifier: str) -> str:
        from app.core.config import settings
        from jose import jwt
        from datetime import datetime, timedelta, timezone
        
        expire = datetime.now(timezone.utc) + timedelta(minutes=10)
        to_encode = {"exp": expire, "sub": f"temp_verify:{identifier}"}
