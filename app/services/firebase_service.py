...
class FirebaseService:
    ...
    def initialize(cls):
        ...
        if not os.path.isabs(cred_path):
            # Resolve relative path from project root (3 directories up from app/services/firebase_service.py)
    ...
    def verify_id_token(cls, id_token: str) -> dict:
        ...
        """
        # Simulated/Mock token bypass for local development/testing when Firebase is offline
        ...
        try:
            # verify_id_token validates signature, expiration, issuer, audience, etc.
